...
<table border='3'>
<?php
$link = mysqli_connect('127.0.0.1:3306', 'root', '', 'test');
...
$qr = $an1R['r'];
    ...
    {if (!$_POST['ans']){
	echo ("<table border='3'><tr><td><center><p>��� ������</p></center></td></tr>");}
		else if ($_POST['ans']==$qr){
      echo ("<tr><td><center><p>���������� �����</p></center></td></tr>");
		}
		else {
			echo ("<tr><td><center><p>������������ �����!</p></center></td></tr>");
			}
...
<tr><td><center><p><input type="submit" name="check" value="�������"></p></center></td></tr>
<tr><td><center><strong><tr><td><center><a href="home.php">��������� ����</a></center></td></tr></strong></center></td></tr>
</form>
