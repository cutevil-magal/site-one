...
class ControllerCommonCart extends Controller {
	public function index() {
		...
		foreach ($this->cart->getProducts() as $product) {
			...
			// $this->load->model('catalog/product');       
            // $categ = $this->model_catalog_product->getCategories($this->request->get['cart_id']);
            // // получили массив с id категорий и id товаров
            // $category_info1 = $this->model_catalog_category->getCategory($categ[0]['category_id']);
            // $catname = $category_info1['name'];     //название категории    
