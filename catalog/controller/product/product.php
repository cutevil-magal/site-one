...
// 		if ($categories) {
// 			// Получаем информацию о первой категории
// 			$category_info = $this->model_catalog_category->getCategory($categories[0]['category_id']);
			
// 			// Теперь вы можете использовать $category_info['name'] для получения названия категории
// 			$category_name = $category_info['name'];
// 			$data['category_name'] = $category_name;

// // Загрузка шаблона с переданными данными
// $this->response->setOutput($this->load->view('product/product', $data));
